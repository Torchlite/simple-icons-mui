...
export default function buffer(props) {
	return (
		<SvgIcon viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414" {...props}>
			<path d="M15.858 12.16c.19.095.19.178 0 .25l-7.574 3.483c-.19.095-.38.095-.568 0L.142 12.41c-.19-.072-.19-.155 0-.25l1.814-.818c.19-.095.38-.095.568 0l5.192 2.382c.19.095.38.095.568 0l5.192-2.382c.19-.095.38-.095.568 0l1.814.818zm0-4.302c.19.095.19.19 0 .284l-7.574 3.485c-.19.07-.38.07-.568 0L.142 8.142c-.19-.095-.19-.19 0-.284l1.814-.818c.19-.095.38-.095.568 0l5.192 2.382c.19.095.38.095.568 0l5.192-2.382c.19-.095.38-.095.568 0l1.814.818zM.142 3.84c-.19-.095-.19-.178 0-.25L7.716.108c.19-.095.38-.095.568 0l7.574 3.484c.19.072.19.155 0 .25L8.284 7.324c-.19.095-.38.095-.568 0L.142 3.84z" fill-rule="nonzero"></path>
		</SvgIcon>
	);
}